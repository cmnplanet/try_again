...
// A: Hello, how are you? Tim  -- using the example above
...
let low  = 10;
let math = high - low;
// A: The difference between 50 and 10 -- 40


// 6.
// What is `math` set to?
math = high - "5";
// A: NaN -- the number 5 has been classed as a string
...
let born = 1984;
let today = 2017;
// A: let age = givenName + " is " + today - born + "years old."
...
// A:
// Chris is taking a class at The Iron Yard, my instructor's Gargi
